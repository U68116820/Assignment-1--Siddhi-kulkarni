...
namespace Assignment_1__Siddhi_kulkarni
{
    class Program
        {
            ...
            private static void printTriangle(int n)
            {
                ...
                */
                {
                    int x, y, count = 1;
                    count = n - 1; //count is one number less than given input
                    for (y = 1; y <= n; y++)
                    {
                        for (x = 1; x <= 2 * y - 1; x++) //for loop to execute statements from n to 1.
                            Console.Write("*"); // printing * pattern
